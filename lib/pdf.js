...
// Opens the PDF in a new tab and triggers the browser's print dialog — handy when she wants
// a paper copy straight away instead of sending it anywhere.
export function printPdf(writings, templates) {
  const doc = buildPdf(writings, templates);
